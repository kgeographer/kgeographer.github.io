...
- historical travel models and narrative maps of the Roman world  
- visual and analytical tools for urban nature and environmental justice  
- living archives for archaeological fieldwork  
...
- **Geographic information workflows** (spatial databases, gazetteers, historical place data)  
- **Prototype web applications** in Python/Django and related stacks  
- **Narrative and text-analysis pipelines**, experimental use and evaluation of AI technologies and methods (LLMs, embeddings)
- **Consulting on DH infrastructure**, especially where place, time, and story intersect  
